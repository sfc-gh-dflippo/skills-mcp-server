...
function ensureGitignore() {
    ...
    if (fs.existsSync(gitignorePath)) {
        ...
        if (!content.includes(gitignoreEntry) && !content.includes("repositories")) {
...
async function cloneOrPullRepo(url, targetPath) {
...
function scanAllSkills(projectRoot, repoPaths) {
    const localSkills = {};
    const repoSkills = {};
...
function formatSkillsSection(localSkills, repoSkills) {
    const lines = [];
...
function updateAgentsMd(content) {
