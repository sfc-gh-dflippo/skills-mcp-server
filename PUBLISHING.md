...
- ✅ **Git tags** matching `v*` → Runs tests + publishes
...
1. **Create a new release on GitHub:**
   - Go to: https://github.com/sfc-gh-dflippo/skills-mcp-server/releases/new
   - Tag: `v1.0.0`
   - Title: `v1.0.0`
...
1. Go to: https://github.com/sfc-gh-dflippo/skills-mcp-server/actions
